...
public class TariffTests
{
  ...
  public void testSimpleRate ()
  {
    ...
    assertEquals(-2.42, te.getUsageCharge(now.minusMillis(TimeService.DAY), 20.0), 1e-6, "correct charge yesterday");
    assertEquals(-12.1, te.getUsageCharge(now.plusMillis(TimeService.DAY), 100.0), 1e-6, "correct charge tomorrow");
    assertEquals(-3.63, te.getUsageCharge(now.minusMillis(TimeService.HOUR), 30.0), 1e-6, "correct charge an hour ago");
    assertEquals(-1.21, te.getUsageCharge(now.plusMillis(TimeService.HOUR), 10.0), 1e-6, "correct charge an hour from now");
  ...
  public void testTimeOfUseDaily ()
  {
    ...
    timeService.setCurrentTime(ZonedDateTime.of(2011, 1, 1, 18, 0, 0, 0,  ZoneOffset.UTC).toInstant());
    ...
    timeService.setCurrentTime(ZonedDateTime.of(2011, 1, 2, 0, 0, 0, 0,  ZoneOffset.UTC).toInstant());
    ...
    timeService.setCurrentTime(ZonedDateTime.of(2011, 1, 2, 7, 0, 0, 0,  ZoneOffset.UTC).toInstant());
  ...
  public void testTimeOfUseWeekly ()
  {
    ...
    timeService.setCurrentTime(ZonedDateTime.of(2011, 1, 3, 0, 0, 0, 0,  ZoneOffset.UTC).toInstant());
    ...
    timeService.setCurrentTime(ZonedDateTime.of(2011, 1, 3, 6, 59, 0, 0,  ZoneOffset.UTC).toInstant());
    ...
    timeService.setCurrentTime(ZonedDateTime.of(2011, 1, 3, 7, 0, 0, 0,  ZoneOffset.UTC).toInstant());
    ...
    timeService.setCurrentTime(ZonedDateTime.of(2011, 1, 4, 12, 0, 0, 0,  ZoneOffset.UTC).toInstant());
    ...
    timeService.setCurrentTime(ZonedDateTime.of(2011, 1, 5, 17, 0, 0, 0,  ZoneOffset.UTC).toInstant());
    ...
    timeService.setCurrentTime(ZonedDateTime.of(2011, 1, 6, 18, 0, 0, 0,  ZoneOffset.UTC).toInstant());
    ...
    timeService.setCurrentTime(ZonedDateTime.of(2011, 1, 7, 23, 59, 0, 0,  ZoneOffset.UTC).toInstant());
    ...
    timeService.setCurrentTime(ZonedDateTime.of(2011, 1, 8, 12, 0, 0, 0,  ZoneOffset.UTC).toInstant());
  ...
  public void testTimeOfUseWeeklyWrap ()
  {
    ...
    Tariff te = new Tariff(tariffSpec);
    te.init();
    timeService.setCurrentTime(ZonedDateTime.of(2011, 1, 1, 23, 50, 0, 0,  ZoneOffset.UTC).toInstant());
    ...
    timeService.setCurrentTime(ZonedDateTime.of(2011, 1, 3, 20, 0, 0, 0,  ZoneOffset.UTC).toInstant());
    assertEquals(-0.48, te.getUsageCharge(8.0, true), 1e-6, "20:00 Mon");
    timeService.setCurrentTime(ZonedDateTime.of(2011, 1, 4, 1, 0, 0, 0,  ZoneOffset.UTC).toInstant());
    assertEquals(-0.12, te.getUsageCharge(2.0, true), 1e-6, "1:00 Tue");
    timeService.setCurrentTime(ZonedDateTime.of(2011, 1, 4, 12, 0, 0, 0,  ZoneOffset.UTC).toInstant());
    assertEquals(-0.3, te.getUsageCharge(5.0, true), 1e-6, "noon Tue");
    timeService.setCurrentTime(ZonedDateTime.of(2011, 1, 4, 23, 59, 0, 0,  ZoneOffset.UTC).toInstant());
    assertEquals(-3.0, te.getUsageCharge(50.0, true), 1e-6, "23:56 Tue");
    timeService.setCurrentTime(ZonedDateTime.of(2011, 1, 5, 0, 0, 0, 0,  ZoneOffset.UTC).toInstant());
    assertEquals(-0.64, te.getUsageCharge(8.0, true), 1e-6, "midnight Wed");
    timeService.setCurrentTime(ZonedDateTime.of(2011, 1, 5, 12, 0, 0, 0,  ZoneOffset.UTC).toInstant());
...
//    timeService.setCurrentTime(ZonedDateTime.of(2011, 1, 2, 18, 0, 0, 0,  ZoneOffset.UTC).toInstant());
...
//  }
  ...
  public void testVarRate ()
  {
    ...
    r1.addHourlyCharge(new HourlyCharge(ZonedDateTime.of(2011, 1, 1, 12, 0, 0, 0,  ZoneOffset.UTC).toInstant(), -0.09), true);
    r1.addHourlyCharge(new HourlyCharge(ZonedDateTime.of(2011, 1, 1, 13, 0, 0, 0,  ZoneOffset.UTC).toInstant(), -0.11), true);
    r1.addHourlyCharge(new HourlyCharge(ZonedDateTime.of(2011, 1, 1, 14, 0, 0, 0,  ZoneOffset.UTC).toInstant(), -0.13), true);
    r1.addHourlyCharge(new HourlyCharge(ZonedDateTime.of(2011, 1, 1, 15, 0, 0, 0,  ZoneOffset.UTC).toInstant(), -0.14));
    assertEquals(-0.9, te.getUsageCharge(10.0, false), 1e-6, "current charge, noon Sunday");
    assertEquals(-1.1, te.getUsageCharge(ZonedDateTime.of(2011, 1, 1, 13, 0, 0, 0,  ZoneOffset.UTC).toInstant(), 10.0), 1e-6, "13:00 charge, noon Sunday");
    assertEquals(-1.3, te.getUsageCharge(ZonedDateTime.of(2011, 1, 1, 14, 0, 0, 0,  ZoneOffset.UTC).toInstant(), 10.0), 1e-6, "14:00 charge, noon Sunday");
    assertEquals(-1.4, te.getUsageCharge(ZonedDateTime.of(2011, 1, 1, 15, 0, 0, 0,  ZoneOffset.UTC).toInstant(), 10.0), 1e-6, "15:00 charge, noon Sunday");
    assertEquals(-1.0, te.getUsageCharge(ZonedDateTime.of(2011, 1, 1, 16, 0, 0, 0,  ZoneOffset.UTC).toInstant(), 10.0), 1e-6, "16:00 charge, noon Sunday");
    assertEquals(-0.8, te.getUsageCharge(ZonedDateTime.of(2011, 1, 1, 18, 0, 0, 0,  ZoneOffset.UTC).toInstant(), 10.0), 1e-6, "18:00 charge, noon Sunday");
  }
  ...
  public void testMultiRateCurtailment ()
  {
    ...
    timeService.setCurrentTime(ZonedDateTime.of(2011, 1, 1, 17, 0, 0, 0,  ZoneOffset.UTC).toInstant());
