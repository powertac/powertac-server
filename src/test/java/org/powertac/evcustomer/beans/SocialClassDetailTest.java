...
public class SocialClassDetailTest
{
  ...
  {
    assertEquals(socialClassDetail.getName(), name);
    assertEquals(socialClassDetail.getMinCount(), minCount);
    assertEquals(socialClassDetail.getMaxCount(), maxCount);
    assertEquals(socialClassDetail.getSocialGroupDetails(), socialGroupDetails);
  }
}